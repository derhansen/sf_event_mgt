...
mysql -u$DB_USERNAME -p$DB_PASSWORD_V8 typo3_sfeventmgt_acceptance_v13 -e "DELETE FROM tx_sfeventmgt_domain_model_registration WHERE uid NOT IN(1, 2, 203, 220); DELETE FROM tx_sfeventmgt_domain_model_registration_fieldvalue;" -h127.0.0.1 --port 3406
mysqldump --no-data -u$DB_USERNAME -p$DB_PASSWORD_V8 -h127.0.0.1 --port 3406 typo3_sfeventmgt_acceptance_v13 > typo3.sql
mysqldump --no-create-info \
          ...
          -u$DB_USERNAME -p$DB_PASSWORD_V8 -h127.0.0.1 --port 3406 typo3_sfeventmgt_acceptance_v13 >> typo3.sql
