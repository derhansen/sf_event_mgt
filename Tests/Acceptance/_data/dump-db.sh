...
mysql -u$DB_USERNAME -p$DB_PASSWORD typo3_sfeventmgt_acceptance_v11 -e "DELETE FROM tx_sfeventmgt_domain_model_registration WHERE uid NOT IN(1, 2, 203, 220); DELETE FROM tx_sfeventmgt_domain_model_registration_fieldvalue;"
mysqldump --no-data -u$DB_USERNAME -p$DB_PASSWORD typo3_sfeventmgt_acceptance_v11 > typo3.sql
